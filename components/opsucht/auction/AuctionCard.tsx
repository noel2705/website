        ...
        <div className={`auction-card ${isdesired ? "desired" : ""}`}>
            {cardSettings.showImage && (
                <div className="item-image-container">
                    ...
                    {isdesired && cardSettings.showDesiredBadge && (
                        <img
                            src="/desired.jpg"
                            alt="Begehrt"
            ...
            {(cardSettings.showDisplayName || cardSettings.showMaterial) && (
                <div className="auction-title-block">
                    {cardSettings.showDisplayName && <h2 className="auction-title">{itemName}</h2>}
                    {cardSettings.showMaterial && (
                        <p className="auction-subtitle">Material: {itemMaterial}</p>
                    )}
                </div>
            )}

            {cardSettings.showAmount && (
                <p className="auction-amount">Menge: {itemAmount}</p>
            )}

            <div className="auction-details">
                {cardSettings.showSeller && (
                ...
                {cardSettings.showCategory && (
                    <p className="auction-category">Kategorie: {auction.category}</p>
                )}

                {cardSettings.showBids && (
